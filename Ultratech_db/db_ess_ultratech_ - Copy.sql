...
CREATE DEFINER=`db_ess_ultratech_`@`localhost` FUNCTION `upsertAssignLeave` (`em_code` VARCHAR(64), `type_id` INT(11), `current_leave` VARCHAR(50), `carry_forward_leave` VARCHAR(50), `dateyear` VARCHAR(64)) RETURNS VARCHAR(100) CHARSET utf8mb4 BEGIN
declare cnt int(10);
